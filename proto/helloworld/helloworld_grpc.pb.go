...
func (c *myStreamServiceClient) RequestPoints(ctx context.Context, in *PointsRequest, opts ...grpc.CallOption) (MyStreamService_RequestPointsClient, error) {
	stream, err := c.cc.NewStream(ctx, &MyStreamService_ServiceDesc.Streams[0], "/helloworld.MyStreamService/RequestPoints", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *myStreamServiceClient) StreamPoints(ctx context.Context, opts ...grpc.CallOption) (MyStreamService_StreamPointsClient, error) {
	stream, err := c.cc.NewStream(ctx, &MyStreamService_ServiceDesc.Streams[1], "/helloworld.MyStreamService/StreamPoints", opts...)
	if err != nil {
		return nil, err
	}
