...
func (c *someServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	...
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, SomeService_SayHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterSomeServiceServer(s grpc.ServiceRegistrar, srv SomeServiceServer) {
	// If the following call panics, it indicates UnimplementedSomeServiceServer was
...
func (c *someService2Client) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply2, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply2)
	err := c.cc.Invoke(ctx, SomeService2_SayHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSomeService2Server must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedSomeService2Server) testEmbeddedByValue()                      {}
...
func RegisterSomeService2Server(s grpc.ServiceRegistrar, srv SomeService2Server) {
	// If the following call panics, it indicates UnimplementedSomeService2Server was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
