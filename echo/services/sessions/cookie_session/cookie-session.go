...
type (
	service struct {
		sessionStore    contracts_sessions.ICookieSessionStore
...
func AddTransientCookieSession(b di.ContainerBuilder) {
	di.AddTransient[*service](b,
		stemService.Ctor,
		reflect.TypeOf((*contracts_sessions.IInternalCookieSession)(nil)),
		reflect.TypeOf((*contracts_sessions.ICookieSession)(nil)),
	)
}
